...
// const asciiCodes = [83, 97, 108, 97, 109, 32, 65, 122, 101, 114, 98, 97, 121, 99, 97, 110]
// let result = '';
// for( let i = 0; i < asciiCodes.length; i++) {
//     let letter = String.fromCharCode(asciiCodes[i])
//     result += letter;
...
// const asciiCodes = [106, 97, 118, 97, 115, 99, 114, 105, 112, 116, 32, 105, 115, 32, 98, 111, 109, 98, 97];
// let result = '';
// for (let i=0; i<asciiCodes.length; i++){
//     let letter = String.fromCharCode(asciiCodes[i])
//     result += letter
...
// example: cinema // iceman // true
// example: listen // silent // true
>>>>>>> 3c56d2d2efcb5d90b180f1b9b15253c908311df9
// example: hello // world // false